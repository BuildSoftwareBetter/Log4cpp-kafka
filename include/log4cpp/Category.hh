...
namespace log4cpp {
     ...
     * their evaluation.
     * 
     * log4cpp的一个特征就是catrgory层级/体系
     * catrgory是一个层级结构，有一个根节点是rootCategory，子节点默认继承父节点属性
     * rootCategory=DEBUG,rootAppender
     * [category]=[Priority::Value],[appender]
     * 
     * 层级是以.划分的，例如：
     * Category.c1.c2 : 代表 根节点 -> c1 节点 -> c2 节点
     * 
     * Category是阈值和appender的组合类
     **/   
    class LOG4CPP_EXPORT Category {
        friend class HierarchyMaintainer;   //友元类 在一个类中指明其他的类（或者）函数能够直接访问该类中的private和protected成员。
        ...
        */       
         ...
         * 
         * 添加appender，当appender为空指针时，移除所有appender
         **/
